package com.youdai.daichao.project.system.dept.controller;
...
import com.youdai.daichao.project.system.dept.service.IDeptService;
...
public class DeptController extends BaseController
{
    ...
    {
        if(deptService.selectDeptById(dept.getDeptId()).getDelFlag().equals("1")){
            return error(1, "系统定义部门，不允许修改");
        }
    ...
    public AjaxResult remove(@PathVariable("deptId") Long deptId)
    {
        ...
        if(deptService.selectDeptById(deptId).getDelFlag().equals("1")){
            return error(1, "系统定义部门，不允许删除");
        }
